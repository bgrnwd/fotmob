...
describe('safeTypeCastFetch', () => {
    ...
    it('League should return League', async () => {
        ...
        await expect(fot.safeTypeCastFetch<League>("https://www.fotmob.com/api/leagues?id=47", ConvertLeague.toLeague)).resolves.not.toThrow();
    });
    it('League should return MatchDetails', async () => {
        ...
        await expect(fot.safeTypeCastFetch<MatchDetails>("https://www.fotmob.com/api/matchDetails?matchId=4193696", ConvertMatchDetails.toMatchDetails)).resolves.not.toThrow();
    });
    it('League should return Team', async () => {
        ...
        await expect(fot.safeTypeCastFetch<Team>("https://www.fotmob.com/api/leagues?id=47", ConvertTeam.toTeam)).resolves.not.toThrow();
    });
    it('League should return Player', async () => {
        ...
        await expect(fot.safeTypeCastFetch<Player>("https://www.fotmob.com/api/playerData?id=30893", ConvertPlayer.toPlayer)).resolves.not.toThrow();
    });
